...
void get_cfg_dat_JOIN_INNER_TD_8100064_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((ss_sold_date_sk#3547 = d_date_sk#3570))
    // Left Table: ListBuffer(ss_sold_date_sk#3547, ss_item_sk#3549, ss_store_sk#3554, ss_sales_price#3560)
    // Right Table: ListBuffer(d_date_sk#3570)
    // Output Table: ListBuffer(ss_item_sk#3549, ss_store_sk#3554, ss_sales_price#3560)
    // Node Depth: 8
    ap_uint<512>* b = hbuf;
...
void get_cfg_dat_Aggregate_TD_762968_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(ss_store_sk#3554, ss_item_sk#3549, MakeDecimal(sum(UnscaledValue(ss_sales_price#3560)),17,2) AS revenue#3546)
    // Input Table: ListBuffer(ss_item_sk#3549, ss_store_sk#3554, ss_sales_price#3560)
    // Output Table: ListBuffer(ss_store_sk#3554, ss_item_sk#3549, revenue#3546)
    // Node Depth: 7
    ...
    // eval0
    ap_uint<32> t;
    signed char id[] = {2,1,0,-1,-1,-1,-1,-1};
    for (int c = 0; c < 4; ++c) {
    ...
    ap_uint<289> op_eval_0 = 0; // ss_sales_price#3560
    ...
    shuffle1_cfg(7, 0) = 0; // ss_sales_price
    shuffle1_cfg(15, 8) = 1; // ss_store_sk#3554
    shuffle1_cfg(23, 16) = 2; // ss_item_sk
    shuffle1_cfg(31, 24) = 8; // revenue
    ...
    // eval1 -> filter
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 0; // ss_sales_price
    shuffle2_cfg(15, 8) = 1; // ss_store_sk
    shuffle2_cfg(23, 16) = 2; // ss_item_sk
    shuffle2_cfg(31, 24) = 3; // revenue
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    // filter -> groupBy
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 1; // ss_store_sk#3554
    shuffle3_cfg(15, 8) = 2; // ss_item_sk#3549
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 3; // revenue#3546
    shuffle4_cfg(15, 8) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_6343340_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_Aggregate_TD_5599450_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(ss_store_sk#1213, ss_item_sk#1208, MakeDecimal(sum(UnscaledValue(ss_sales_price#1219)),17,2) AS revenue#3544)
    // Input Table: ListBuffer(ss_item_sk#1208, ss_store_sk#1213, ss_sales_price#1219)
    // Output Table: ListBuffer(ss_store_sk#1213, revenue#3544)
    // Node Depth: 5
    ap_uint<32>* config = buf;
    memset(config, 0, sizeof(ap_uint<32>) * 83);
    ...
    ap_uint<289> op_eval_0 = 0; // ss_sales_price#1219
    xf::database::dynamicALUOPCompiler<uint32_t, uint32_t, uint32_t, uint32_t>("strm1", 0, 0, 0, 0, op_eval_0);
    for (int i = 0; i < 9; i++) {
        config[i + 2] = op_eval_0(32 * (i + 1) - 1, 32 * i);
    }
    ...
    ap_int<64> shuffle1_cfg;
    shuffle1_cfg(7, 0) = 0; // ss_sales_price
    shuffle1_cfg(15, 8) = 1; // ss_store_sk#1213
    shuffle1_cfg(23, 16) = 2; // ss_item_sk
    shuffle1_cfg(31, 24) = 8; // revenue
    shuffle1_cfg(39, 32) = -1;
    shuffle1_cfg(47, 40) = -1;
    ...
    // filter -> groupBy
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 1; // ss_store_sk#1213
    shuffle3_cfg(15, 8) = 2; // ss_item_sk#1208
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 3; // revenue#3544
    shuffle4_cfg(15, 8) = -1;
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
...
void get_cfg_dat_Aggregate_TD_4332386_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(ss_store_sk#1213, avg(revenue#3544) AS ave#3545)
    // Input Table: ListBuffer(ss_store_sk#1213, revenue#3544)
    // Output Table: ListBuffer(ss_store_sk#1213, ave#3545)
    // Node Depth: 4
    ap_uint<32>* config = buf;
    memset(config, 0, sizeof(ap_uint<32>) * 83);
    ...
    // NO evaluation 1 in aggregation expression - eval1
    ap_int<64> shuffle1_cfg;
    shuffle1_cfg(7, 0) = 0; // ss_store_sk#1213
    shuffle1_cfg(15, 8) = 1; // revenue#3544
    ...
    // eval1 -> filter
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 0; // ss_store_sk
    shuffle2_cfg(15, 8) = 1; // revenue
    ...
    // filter -> groupBy
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // ss_store_sk#1213
    shuffle3_cfg(15, 8) = -1;
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
