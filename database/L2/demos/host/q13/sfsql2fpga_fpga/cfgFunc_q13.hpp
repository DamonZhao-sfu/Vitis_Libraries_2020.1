...
void get_cfg_dat_JOIN_INNER_TD_0152_gqe_join(ap_uint<512>* hbuf) {
...
void get_cfg_dat_JOIN_INNER_TD_0152_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_LEFTANTI_TD_3550_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
...
void get_cfg_dat_JOIN_LEFTANTI_TD_3550_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_Aggregate_TD_212_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(c_custkey#22, count(o_orderkey#207) AS c_count#1386L)
    // Input Table: ListBuffer(c_custkey#22, o_orderkey#207)
    // Output Table: ListBuffer(c_count#1386L)
    // Node Depth: 2
    ...
    shuffle1_cfg(7, 0) = 0; // c_custkey#22
    shuffle1_cfg(15, 8) = 1; // o_orderkey#207
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 1; // c_count#1386L
    shuffle4_cfg(15, 8) = -1;
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
...
void get_cfg_dat_Aggregate_TD_212_gqe_aggr_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_Aggregate_TD_1543_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(c_count#1386L, count(1) AS custdist#1381L)
    // Input Table: ListBuffer(c_count#1386L)
    // Output Table: ListBuffer(c_count#1386L, custdist#1381L)
    // Node Depth: 1
    ap_uint<32>* config = buf;
    memset(config, 0, sizeof(ap_uint<32>) * 83);
    ...
    // NO evaluation 1 in aggregation expression - eval1
    ap_int<64> shuffle1_cfg;
    shuffle1_cfg(7, 0) = 0; // c_count#1386L
    shuffle1_cfg(15, 8) = -1;
    shuffle1_cfg(23, 16) = -1;
    shuffle1_cfg(31, 24) = -1;
    shuffle1_cfg(39, 32) = -1;
    ...
    // eval1 -> filter
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 0; // c_count#1386L
    shuffle2_cfg(15, 8) = -1;
    shuffle2_cfg(23, 16) = -1;
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    ...
    // filter -> groupBy
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // c_count#1386L
    shuffle3_cfg(15, 8) = -1;
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = -1; // custdist#1381L
    shuffle4_cfg(15, 8) = -1;
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
...
void get_cfg_dat_Aggregate_TD_1543_gqe_aggr_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
