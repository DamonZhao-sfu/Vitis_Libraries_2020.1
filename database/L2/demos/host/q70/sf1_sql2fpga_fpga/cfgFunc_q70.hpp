...
void get_cfg_dat_JOIN_INNER_TD_7883227_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 7; // ss_store_sk
    shuffle2_cfg(15, 8) = 6; // ss_net_profit
    ...
    shuffle3_cfg(15, 8) = 1; // ss_net_profit
    ...
    shuffle4_cfg(15, 8) = 1; // ss_net_profit
