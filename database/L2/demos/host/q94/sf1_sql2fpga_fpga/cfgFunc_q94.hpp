...
void get_cfg_dat_JOIN_LEFTSEMI_TD_5499524_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer(((ws_order_number#746L = ws_order_number#3566L) AND NOT (ws_warehouse_sk#744 = ws_warehouse_sk#3564)))
    // Left Table: ListBuffer(ws_warehouse_sk#3564, ws_order_number#3566L)
    // Right Table: ListBuffer(ws_ship_date_sk#731, ws_ship_addr_sk#740, ws_web_site_sk#742, ws_warehouse_sk#744, ws_order_number#746L, ws_ext_ship_cost#757, ws_net_profit#762)
    ...
    shuffle1b_cfg(39, 32) = 6;
    shuffle1b_cfg(47, 40) = 1;
    shuffle1b_cfg(55, 48) = 5;
    ...
    shuffle2_cfg(7, 0) = 1; // ws_ship_date_sk
    shuffle2_cfg(15, 8) = 4; // ws_ship_addr_sk
    shuffle2_cfg(23, 16) = 2; // ws_web_site_sk
    shuffle2_cfg(31, 24) = 12; // ws_order_number
    shuffle2_cfg(39, 32) = 5; // ws_ext_ship_cost
    shuffle2_cfg(47, 40) = 3; // ws_net_profit
...
void get_cfg_dat_JOIN_LEFTANTI_TD_4651670_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    ...
    // Right Table: ListBuffer(ws_ship_date_sk#731, ws_ship_addr_sk#740, ws_web_site_sk#742, ws_order_number#746L, ws_ext_ship_cost#757, ws_net_profit#762)
    // Output Table: ListBuffer(ws_ship_date_sk#731, ws_ship_addr_sk#740, ws_web_site_sk#742, ws_order_number#746L, ws_ext_ship_cost#757, ws_net_profit#762)
    // Node Depth: 4
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
...
void get_cfg_dat_JOIN_INNER_TD_3137012_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
...
void get_cfg_dat_JOIN_INNER_TD_233645_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_JOIN_INNER_TD_1453782_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
