...
void get_cfg_dat_JOIN_INNER_TD_6832803_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(15, 8) = 9; // ss_hdemo_sk
    shuffle2_cfg(23, 16) = 8; // ss_store_sk
    shuffle2_cfg(31, 24) = 7; // ss_ticket_number
...
void get_cfg_dat_JOIN_INNER_TD_5137958_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 6; // ss_customer_sk
    shuffle2_cfg(15, 8) = 8; // ss_hdemo_sk
    shuffle2_cfg(23, 16) = 7; // ss_ticket_number
...
void get_cfg_dat_JOIN_INNER_TD_4630085_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 6; // ss_customer_sk
    shuffle2_cfg(15, 8) = 7; // ss_ticket_number
    ...
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // ss_customer_sk
    shuffle3_cfg(15, 8) = 1; // ss_ticket_number
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // ss_customer_sk
    shuffle4_cfg(15, 8) = 1; // ss_ticket_number
...
void get_cfg_dat_Aggregate_TD_3379653_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(ss_ticket_number#1215L, ss_customer_sk#1209, count(1) AS cnt#3544L)
    // Input Table: ListBuffer(ss_customer_sk#1209, ss_ticket_number#1215L)
    // Output Table: ListBuffer(ss_ticket_number#1215L, ss_customer_sk#1209, cnt#3544L)
    // Node Depth: 3
    ...
    shuffle1_cfg(7, 0) = 0; // ss_customer_sk#1209
    shuffle1_cfg(15, 8) = 1; // ss_ticket_number#1215L
    ...
    // eval1 -> filter
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 0; // ss_customer_sk
    shuffle2_cfg(15, 8) = 1; // ss_ticket_number
    shuffle2_cfg(23, 16) = -1;
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    ...
    // filter -> groupBy
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 1; // ss_ticket_number#1215L
    shuffle3_cfg(15, 8) = 0; // ss_customer_sk#1209
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
