...
void get_cfg_dat_JOIN_INNER_TD_6478923_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(15, 8) = 7; // cs_sales_price
    ...
    shuffle3_cfg(15, 8) = 1; // cs_sales_price
    ...
    shuffle4_cfg(15, 8) = 1; // cs_sales_price
