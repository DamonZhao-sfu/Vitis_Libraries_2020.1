...
void get_cfg_dat_Aggregate_TD_5138_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(l_suppkey#79, sum((l_extendedprice#82 * (1 - l_discount#83))) AS total_revenue#1476L)
    // Input Table: ListBuffer(l_suppkey#79, l_extendedprice#82, l_discount#83)
    // Output Table: ListBuffer(total_revenue#1476L)
    // Node Depth: 5
    ...
    shuffle1_cfg(31, 24) = 8; // total_revenue#1476L
    ...
    shuffle2_cfg(31, 24) = 3; // total_revenue#1476L
    ...
    shuffle4_cfg(7, 0) = 3; // total_revenue#1476L
    shuffle4_cfg(15, 8) = -1;
...
void get_cfg_dat_Aggregate_TD_5138_gqe_aggr_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
...
void get_cfg_dat_Aggregate_TD_4225_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(l_suppkey#79, sum((l_extendedprice#82 * (1 - l_discount#83))) AS sum((l_extendedprice * (1 - l_discount)))#1474L)
    // Input Table: ListBuffer(l_suppkey#79, l_extendedprice#82, l_discount#83)
    // Output Table: ListBuffer(l_suppkey#79, sum((l_extendedprice * (1 - l_discount)))#1474L)
    // Node Depth: 4
    ap_uint<32>* config = buf;
    memset(config, 0, sizeof(ap_uint<32>) * 83);
    ...
    shuffle1_cfg(15, 8) = 1; // l_discount#83
    shuffle1_cfg(23, 16) = 2; // l_suppkey#79
    shuffle1_cfg(31, 24) = 8; // sum((l_extendedprice * (1 - l_discount)))#1474L
    shuffle1_cfg(39, 32) = -1;
    shuffle1_cfg(47, 40) = -1;
    shuffle1_cfg(55, 48) = -1;
    shuffle1_cfg(63, 56) = -1;
    ...
    shuffle2_cfg(15, 8) = 1; // l_discount#83
    shuffle2_cfg(23, 16) = 2; // l_suppkey#79
    shuffle2_cfg(31, 24) = 3; // sum((l_extendedprice * (1 - l_discount)))#1474L
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 3; // sum((l_extendedprice * (1 - l_discount)))#1474L
    shuffle4_cfg(15, 8) = -1;
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
...
void get_cfg_dat_Aggregate_TD_4225_gqe_aggr_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_INNER_TD_191_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: true StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((s_suppkey#342 = supplier_no#1475))
    // Left Table: ListBuffer(s_suppkey#342, s_name#343, s_address#344, s_phone#346)
    // Right Table: ListBuffer(supplier_no#1475, total_revenue#1476L)
    // Output Table: ListBuffer(s_suppkey#342, s_name#343, s_address#344, s_phone#346, total_revenue#1476L)
    // Node Depth: 1
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 12; // s_suppkey#342
    shuffle2_cfg(15, 8) = 8; // s_name#343
    shuffle2_cfg(23, 16) = 6; // s_address#344
    shuffle2_cfg(31, 24) = 7; // s_phone#346
    shuffle2_cfg(39, 32) = 0; // total_revenue#1476L
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    shuffle3_cfg(23, 16) = 2; // s_address#344
    shuffle3_cfg(31, 24) = 3; // s_phone#346
    shuffle3_cfg(39, 32) = 4; // total_revenue#1476L
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    shuffle4_cfg(23, 16) = 2; // s_address#344
    shuffle4_cfg(31, 24) = 3; // s_phone#346
    shuffle4_cfg(39, 32) = 4; // total_revenue#1476L
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_191_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;

    // input table a
    signed char id_a[] = {0,2,3,1,-1,-1,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(56 + 8 * c + 7, 56 + 8 * c) = id_a[c];
    }
    // filter tbl_a config
