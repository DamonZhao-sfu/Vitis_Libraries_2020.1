...
void get_cfg_dat_Aggregate_TD_5179_gqe_aggr(ap_uint<32>* buf) {
    ...
    shuffle1_cfg(23, 16) = 2; // l_suppkey
    shuffle1_cfg(31, 24) = 8; // total_revenue
    ...
    shuffle2_cfg(31, 24) = 3; // total_revenue
...
void get_cfg_dat_Aggregate_TD_4461_gqe_aggr(ap_uint<32>* buf) {
    ...
    shuffle1_cfg(15, 8) = 1; // l_discount
    shuffle1_cfg(23, 16) = 2; // l_suppkey
    shuffle1_cfg(31, 24) = 8; // sum((l_extendedprice * (100 - l_discount)))
    shuffle1_cfg(39, 32) = -1;
    shuffle1_cfg(47, 40) = -1;
    shuffle1_cfg(55, 48) = -1;
    shuffle1_cfg(63, 56) = -1;
    ...
    shuffle2_cfg(15, 8) = 1; // l_discount
    shuffle2_cfg(23, 16) = 2; // l_suppkey
    shuffle2_cfg(31, 24) = 3; // sum((l_extendedprice * (100 - l_discount)))
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_1197_gqe_join(ap_uint<512>* hbuf) {
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // s_suppkey
    shuffle3_cfg(15, 8) = 1; // s_name
    shuffle3_cfg(23, 16) = 2; // s_address
    shuffle3_cfg(31, 24) = 3; // s_phone
    shuffle3_cfg(39, 32) = 4; // total_revenue
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // s_suppkey
    shuffle4_cfg(15, 8) = 1; // s_name
    shuffle4_cfg(23, 16) = 2; // s_address
    shuffle4_cfg(31, 24) = 3; // s_phone
    shuffle4_cfg(39, 32) = 4; // total_revenue
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
