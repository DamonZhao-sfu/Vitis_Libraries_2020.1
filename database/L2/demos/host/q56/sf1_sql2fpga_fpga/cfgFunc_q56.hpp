...
void get_cfg_dat_JOIN_INNER_TD_8413016_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((ws_sold_date_sk#729 = d_date_sk#3614))
    ...
    shuffle2_cfg(15, 8) = 8; // ws_bill_addr_sk
    shuffle2_cfg(23, 16) = 7; // ws_ext_sales_price
    ...
    shuffle3_cfg(15, 8) = 1; // ws_bill_addr_sk
    shuffle3_cfg(23, 16) = 2; // ws_ext_sales_price
    ...
    shuffle4_cfg(15, 8) = 1; // ws_bill_addr_sk
    shuffle4_cfg(23, 16) = 2; // ws_ext_sales_price
...
void get_cfg_dat_JOIN_INNER_TD_8636067_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 8; // cs_bill_addr_sk
    shuffle2_cfg(15, 8) = 7; // cs_item_sk
    shuffle2_cfg(23, 16) = 6; // cs_ext_sales_price
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // cs_bill_addr_sk
    shuffle3_cfg(15, 8) = 1; // cs_item_sk
    shuffle3_cfg(23, 16) = 2; // cs_ext_sales_price
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // cs_bill_addr_sk
    shuffle4_cfg(15, 8) = 1; // cs_item_sk
    shuffle4_cfg(23, 16) = 2; // cs_ext_sales_price
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_8344086_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    shuffle2_cfg(15, 8) = 7; // ss_addr_sk
...
void get_cfg_dat_JOIN_INNER_TD_7169986_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((ws_bill_addr_sk#736 = ca_address_sk#3642))
    // Left Table: ListBuffer(ws_item_sk#732, ws_bill_addr_sk#736, ws_ext_sales_price#752)
    // Right Table: ListBuffer(ca_address_sk#3642)
    ...
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 6; // ws_item_sk
    shuffle2_cfg(15, 8) = 7; // ws_ext_sales_price
    ...
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // ws_item_sk
    shuffle3_cfg(15, 8) = 1; // ws_ext_sales_price
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // ws_item_sk
    shuffle4_cfg(15, 8) = 1; // ws_ext_sales_price
...
void get_cfg_dat_JOIN_INNER_TD_7450298_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((cs_bill_addr_sk#1110 = ca_address_sk#3579))
    // Left Table: ListBuffer(cs_bill_addr_sk#1110, cs_item_sk#1119, cs_ext_sales_price#1127)
    // Right Table: ListBuffer(ca_address_sk#3579)
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 7; // cs_item_sk
    shuffle2_cfg(15, 8) = 6; // cs_ext_sales_price
    shuffle2_cfg(23, 16) = -1;
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    ...
    shuffle3_cfg(15, 8) = 1; // cs_ext_sales_price
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    ...
    shuffle4_cfg(15, 8) = 1; // cs_ext_sales_price
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_7486229_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
