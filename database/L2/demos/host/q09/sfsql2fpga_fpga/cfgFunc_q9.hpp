...
void get_cfg_dat_JOIN_INNER_TD_7954_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 4; // l_orderkey#77
    shuffle2_cfg(15, 8) = 12; // l_partkey#78
    shuffle2_cfg(23, 16) = 3; // l_suppkey#79
    shuffle2_cfg(31, 24) = 0; // l_quantity#81
    shuffle2_cfg(39, 32) = 2; // l_extendedprice#82
    shuffle2_cfg(47, 40) = 1; // l_discount#83
    ...
    shuffle3_cfg(15, 8) = 1; // l_partkey#78
    shuffle3_cfg(23, 16) = 2; // l_suppkey#79
    shuffle3_cfg(31, 24) = 3; // l_quantity#81
    ...
    shuffle4_cfg(15, 8) = 1; // l_partkey#78
    shuffle4_cfg(23, 16) = 2; // l_suppkey#79
    shuffle4_cfg(31, 24) = 3; // l_quantity#81
...
void get_cfg_dat_JOIN_INNER_TD_7954_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    // input table b
    signed char id_b[] = {1,3,5,4,2,0,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(120 + 8 * c + 7, 120 + 8 * c) = id_b[c];
    }
    // filter tbl_b config
...
void get_cfg_dat_JOIN_INNER_TD_6822_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    shuffle2_cfg(15, 8) = 4; // l_partkey#78
    shuffle2_cfg(23, 16) = 12; // l_suppkey#79
    shuffle2_cfg(31, 24) = 0; // l_quantity#81
    shuffle2_cfg(39, 32) = 2; // l_extendedprice#82
    shuffle2_cfg(47, 40) = 1; // l_discount#83
    shuffle2_cfg(55, 48) = 6; // s_nationkey#345
    shuffle2_cfg(63, 56) = -1;
    ...
    shuffle3_cfg(39, 32) = 4; // l_extendedprice#82
    shuffle3_cfg(47, 40) = 5; // l_discount#83
    shuffle3_cfg(55, 48) = 6; // s_nationkey#345
    shuffle3_cfg(63, 56) = -1;
    ...
    shuffle4_cfg(39, 32) = 4; // l_extendedprice#82
    shuffle4_cfg(47, 40) = 5; // l_discount#83
    shuffle4_cfg(55, 48) = 6; // s_nationkey#345
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_6822_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    // input table b
    signed char id_b[] = {2,3,5,4,0,1,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(120 + 8 * c + 7, 120 + 8 * c) = id_b[c];
    }
    // filter tbl_b config
...
void get_cfg_dat_JOIN_INNER_TD_5936_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 9; // l_orderkey#77
    shuffle2_cfg(15, 8) = 6; // l_quantity#81
    shuffle2_cfg(23, 16) = 8; // l_extendedprice#82
    shuffle2_cfg(31, 24) = 7; // l_discount#83
    shuffle2_cfg(39, 32) = 10; // s_nationkey#345
    shuffle2_cfg(47, 40) = 0; // ps_supplycost#308
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    shuffle3_cfg(47, 40) = 5; // ps_supplycost#308
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    shuffle4_cfg(47, 40) = 5; // ps_supplycost#308
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_5936_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;

    // input table a
    signed char id_a[] = {2,1,3,5,4,0,6,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(56 + 8 * c + 7, 56 + 8 * c) = id_a[c];
    }
    // filter tbl_a config
...
void get_cfg_dat_JOIN_INNER_TD_4550_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 6; // l_quantity#81
    shuffle2_cfg(15, 8) = 8; // l_extendedprice#82
    shuffle2_cfg(23, 16) = 7; // l_discount#83
    shuffle2_cfg(31, 24) = 9; // s_nationkey#345
    shuffle2_cfg(39, 32) = 10; // ps_supplycost#308
    shuffle2_cfg(47, 40) = 0; // o_orderdate#211
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    shuffle3_cfg(39, 32) = 4; // ps_supplycost#308
    shuffle3_cfg(47, 40) = 5; // o_orderdate#211
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    shuffle4_cfg(39, 32) = 4; // ps_supplycost#308
    shuffle4_cfg(47, 40) = 5; // o_orderdate#211
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_4550_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;

    // input table a
    signed char id_a[] = {0,1,3,2,4,5,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(56 + 8 * c + 7, 56 + 8 * c) = id_a[c];
    }
    // filter tbl_a config
