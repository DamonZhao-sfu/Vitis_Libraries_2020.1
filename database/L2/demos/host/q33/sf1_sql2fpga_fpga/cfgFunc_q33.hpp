...
void get_cfg_dat_JOIN_INNER_TD_8571671_gqe_join(ap_uint<512>* hbuf) {
...
void get_cfg_dat_JOIN_INNER_TD_8764765_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_JOIN_INNER_TD_8288042_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_7524644_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer((i_manufact_id#3668 = i_manufact_id#3734))
    // Left Table: ListBuffer(i_manufact_id#3734)
    // Right Table: ListBuffer(i_item_sk#3655, i_manufact_id#3668)
    // Output Table: ListBuffer(i_item_sk#3655, i_manufact_id#3668)
    // Node Depth: 7
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 0; // i_item_sk
    shuffle2_cfg(15, 8) = 12; // i_manufact_id
    ...
    shuffle3_cfg(15, 8) = 1; // i_manufact_id
    ...
    shuffle4_cfg(15, 8) = 1; // i_manufact_id
...
void get_cfg_dat_JOIN_INNER_TD_7445700_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_7724291_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer((i_manufact_id#3605 = i_manufact_id#3712))
    // Left Table: ListBuffer(i_manufact_id#3712)
    // Right Table: ListBuffer(i_item_sk#3592, i_manufact_id#3605)
    // Output Table: ListBuffer(i_item_sk#3592, i_manufact_id#3605)
    // Node Depth: 7
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_INNER_TD_7860766_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_7347442_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer((i_manufact_id#241 = i_manufact_id#3690))
    // Left Table: ListBuffer(i_manufact_id#3690)
...
void get_cfg_dat_JOIN_INNER_TD_7433416_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_JOIN_INNER_TD_6758993_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((ws_item_sk#732 = i_item_sk#3655))
    // Left Table: ListBuffer(ws_item_sk#732, ws_ext_sales_price#752)
    // Right Table: ListBuffer(i_item_sk#3655, i_manufact_id#3668)
    // Output Table: ListBuffer(ws_ext_sales_price#752, i_manufact_id#3668)
    // Node Depth: 6
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 6; // ws_ext_sales_price
    shuffle2_cfg(15, 8) = 0; // i_manufact_id
    shuffle2_cfg(23, 16) = -1;
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_6766694_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((cs_item_sk#1119 = i_item_sk#3592))
    // Left Table: ListBuffer(cs_item_sk#1119, cs_ext_sales_price#1127)
    // Right Table: ListBuffer(i_item_sk#3592, i_manufact_id#3605)
    // Output Table: ListBuffer(cs_ext_sales_price#1127, i_manufact_id#3605)
    // Node Depth: 6
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 6; // cs_ext_sales_price
    shuffle2_cfg(15, 8) = 0; // i_manufact_id
    shuffle2_cfg(23, 16) = -1;
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // cs_ext_sales_price
    shuffle3_cfg(15, 8) = 1; // i_manufact_id
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // cs_ext_sales_price
    shuffle4_cfg(15, 8) = 1; // i_manufact_id
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_6989915_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_Aggregate_TD_5343411_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(i_manufact_id#3668, MakeDecimal(sum(UnscaledValue(ws_ext_sales_price#752)),17,2) AS total_sales#3549)
    // Input Table: ListBuffer(ws_ext_sales_price#752, i_manufact_id#3668)
    // Output Table: ListBuffer(i_manufact_id#3668, total_sales#3549)
    // Node Depth: 5
    ...
    shuffle1_cfg(7, 0) = 0; // ws_ext_sales_price
    shuffle1_cfg(15, 8) = 1; // i_manufact_id#3668
    shuffle1_cfg(23, 16) = 8; // total_sales
    ...
    shuffle2_cfg(23, 16) = 2; // total_sales
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    ...
    // filter -> groupBy
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 1; // i_manufact_id#3668
    shuffle3_cfg(15, 8) = -1;
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 2; // total_sales#3549
    shuffle4_cfg(15, 8) = -1;
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
...
void get_cfg_dat_Aggregate_TD_5894224_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(i_manufact_id#3605, MakeDecimal(sum(UnscaledValue(cs_ext_sales_price#1127)),17,2) AS total_sales#3547)
    // Input Table: ListBuffer(cs_ext_sales_price#1127, i_manufact_id#3605)
    // Output Table: ListBuffer(i_manufact_id#3605, total_sales#3547)
    // Node Depth: 5
    ap_uint<32>* config = buf;
    memset(config, 0, sizeof(ap_uint<32>) * 83);
    ...
    // NO evaluation 1 in aggregation expression - eval1
    ap_int<64> shuffle1_cfg;
    shuffle1_cfg(7, 0) = 0; // cs_ext_sales_price
    shuffle1_cfg(15, 8) = 1; // i_manufact_id#3605
    shuffle1_cfg(23, 16) = 8; // total_sales
    shuffle1_cfg(31, 24) = -1;
    shuffle1_cfg(39, 32) = -1;
    shuffle1_cfg(47, 40) = -1;
    ...
    // eval1 -> filter
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 0; // cs_ext_sales_price
    shuffle2_cfg(15, 8) = 1; // i_manufact_id
    shuffle2_cfg(23, 16) = 2; // total_sales
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    ...
    // filter -> groupBy
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 1; // i_manufact_id#3605
    shuffle3_cfg(15, 8) = -1;
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 2; // total_sales#3547
    shuffle4_cfg(15, 8) = -1;
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
...
void get_cfg_dat_Aggregate_TD_5453244_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(i_manufact_id#241, MakeDecimal(sum(UnscaledValue(ss_ext_sales_price#1221)),17,2) AS total_sales#3545)
    // Input Table: ListBuffer(ss_ext_sales_price#1221, i_manufact_id#241)
    ...
    shuffle1_cfg(15, 8) = 1; // i_manufact_id#241
    shuffle1_cfg(23, 16) = 8; // total_sales
    shuffle1_cfg(31, 24) = -1;
    shuffle1_cfg(39, 32) = -1;
    shuffle1_cfg(47, 40) = -1;
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 2; // total_sales#3545
    shuffle4_cfg(15, 8) = -1;
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
...
void get_cfg_dat_Aggregate_TD_384003_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(i_manufact_id#241, sum(total_sales#3545) AS total_sales#3544)
    // Input Table: ListBuffer(i_manufact_id#241, total_sales#3545)
    // Output Table: ListBuffer(i_manufact_id#241, total_sales#3544)
    // Node Depth: 3
    ap_uint<32>* config = buf;
    memset(config, 0, sizeof(ap_uint<32>) * 83);
    ...
    // NO evaluation 1 in aggregation expression - eval1
    ap_int<64> shuffle1_cfg;
    shuffle1_cfg(7, 0) = 0; // i_manufact_id#241
    shuffle1_cfg(15, 8) = 1; // total_sales#3545
    ...
    // eval1 -> filter
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 0; // i_manufact_id
    shuffle2_cfg(15, 8) = 1; // total_sales
    shuffle2_cfg(23, 16) = -1;
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    ...
    // filter -> groupBy
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // i_manufact_id#241
    shuffle3_cfg(15, 8) = -1;
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 1; // total_sales#3544
    shuffle4_cfg(15, 8) = -1;
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
