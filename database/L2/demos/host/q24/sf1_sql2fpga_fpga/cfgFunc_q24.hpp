...
void get_cfg_dat_JOIN_INNER_TD_7406547_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 13; // ss_item_sk
    shuffle2_cfg(15, 8) = 6; // ss_customer_sk
    shuffle2_cfg(23, 16) = 8; // ss_store_sk
    shuffle2_cfg(31, 24) = 7; // ss_net_paid
    ...
    shuffle3_cfg(31, 24) = 3; // ss_net_paid
    ...
    shuffle4_cfg(31, 24) = 3; // ss_net_paid
...
void get_cfg_dat_JOIN_INNER_TD_7419839_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer(((ss_ticket_number#1215L = sr_ticket_number#678L) AND (ss_item_sk#1208 = sr_item_sk#671)))
    // Left Table: ListBuffer(ss_item_sk#1208, ss_customer_sk#1209, ss_store_sk#1213, ss_ticket_number#1215L, ss_net_paid#1226)
