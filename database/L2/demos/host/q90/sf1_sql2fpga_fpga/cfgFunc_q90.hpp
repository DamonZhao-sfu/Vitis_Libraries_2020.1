...
void get_cfg_dat_JOIN_INNER_TD_5389505_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((ws_ship_hdemo_sk#3557 = hd_demo_sk#3581))
    // Left Table: ListBuffer(ws_sold_time_sk#3548, ws_ship_hdemo_sk#3557, ws_web_page_sk#3559)
    // Right Table: ListBuffer(hd_demo_sk#3581)
    // Output Table: ListBuffer(ws_sold_time_sk#3548, ws_web_page_sk#3559)
    // Node Depth: 5
    ap_uint<512>* b = hbuf;
    ...
    shuffle2_cfg(7, 0) = 6; // ws_sold_time_sk
    shuffle2_cfg(15, 8) = 7; // ws_web_page_sk
    ...
    shuffle3_cfg(7, 0) = 0; // ws_sold_time_sk
    shuffle3_cfg(15, 8) = 1; // ws_web_page_sk
    ...
    shuffle4_cfg(7, 0) = 0; // ws_sold_time_sk
    shuffle4_cfg(15, 8) = 1; // ws_web_page_sk
...
void get_cfg_dat_JOIN_INNER_TD_5681927_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_JOIN_INNER_TD_4611216_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((ws_sold_time_sk#3548 = t_time_sk#3586))
    // Left Table: ListBuffer(ws_sold_time_sk#3548, ws_web_page_sk#3559)
    // Right Table: ListBuffer(t_time_sk#3586)
    // Output Table: ListBuffer(ws_web_page_sk#3559)
    // Node Depth: 4
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 6; // ws_web_page_sk
    shuffle2_cfg(15, 8) = -1;
    shuffle2_cfg(23, 16) = -1;
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // ws_web_page_sk
    shuffle3_cfg(15, 8) = -1;
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // ws_web_page_sk
    shuffle4_cfg(15, 8) = -1;
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_4724095_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_JOIN_INNER_TD_3747960_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((ws_web_page_sk#3559 = wp_web_page_sk#3596))
    // Left Table: ListBuffer(ws_web_page_sk#3559)
    // Right Table: ListBuffer(wp_web_page_sk#3596)
    // Output Table: ListBuffer(ws_web_page_sk#3559, wp_web_page_sk#3596)
    // Node Depth: 3
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 12; // ws_web_page_sk
    shuffle2_cfg(15, 8) = 12; // wp_web_page_sk
    shuffle2_cfg(23, 16) = -1;
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    ...
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // ws_web_page_sk
    shuffle3_cfg(15, 8) = 1; // wp_web_page_sk
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // ws_web_page_sk
    shuffle4_cfg(15, 8) = 1; // wp_web_page_sk
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_3686188_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
