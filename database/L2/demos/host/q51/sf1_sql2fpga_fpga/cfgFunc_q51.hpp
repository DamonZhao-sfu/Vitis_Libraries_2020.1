...
void get_cfg_dat_JOIN_INNER_TD_9238506_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((ss_sold_date_sk#1206 = d_date_sk#3648))
    // Left Table: ListBuffer(ss_sold_date_sk#1206, ss_item_sk#1208, ss_sales_price#1219)
    // Right Table: ListBuffer(d_date_sk#3648, d_date#3650)
    // Output Table: ListBuffer(ss_item_sk#1208, ss_sales_price#1219, d_date#3650)
    // Node Depth: 9
    ap_uint<512>* b = hbuf;
...
void get_cfg_dat_JOIN_INNER_TD_9717571_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    shuffle2_cfg(15, 8) = 1; // ws_sales_price
    shuffle2_cfg(23, 16) = 2; // d_date
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    ...
    shuffle3_cfg(15, 8) = 1; // ws_sales_price
    shuffle3_cfg(23, 16) = 2; // d_date
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    ...
    shuffle4_cfg(15, 8) = 1; // ws_sales_price
    shuffle4_cfg(23, 16) = 2; // d_date
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
...
void get_cfg_dat_JOIN_FULLOUTER_TD_6746405_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_FULLOUTER
    // Operation: ListBuffer(((item_sk#3644 = item_sk#3646) AND (d_date#122 = d_date#3650)))
    // Left Table: ListBuffer(item_sk#3644, d_date#122, _w0#3680, ws_item_sk#732, cume_sales#3645)
    // Right Table: ListBuffer(item_sk#3646, d_date#3650, _w0#3681, ss_item_sk#1208, cume_sales#3647)
    // Output Table: ListBuffer(item_sk#3644, item_sk#3646, d_date#122, d_date#3650, cume_sales#3645, cume_sales#3647)
    // Node Depth: 6
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 1; // item_sk
    shuffle2_cfg(15, 8) = 1; // item_sk
    shuffle2_cfg(23, 16) = 3; // d_date
    shuffle2_cfg(31, 24) = 3; // d_date
    shuffle2_cfg(39, 32) = 5; // cume_sales
    shuffle2_cfg(47, 40) = 5; // cume_sales
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 1; // item_sk
    shuffle3_cfg(15, 8) = 1; // item_sk
    shuffle3_cfg(23, 16) = 3; // d_date
    shuffle3_cfg(31, 24) = 3; // d_date
    shuffle3_cfg(39, 32) = 5; // cume_sales
    shuffle3_cfg(47, 40) = 5; // cume_sales
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 1; // item_sk
    shuffle4_cfg(15, 8) = 1; // item_sk
    shuffle4_cfg(23, 16) = 3; // d_date
    shuffle4_cfg(31, 24) = 3; // d_date
    shuffle4_cfg(39, 32) = 5; // cume_sales
    shuffle4_cfg(47, 40) = 5; // cume_sales
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
