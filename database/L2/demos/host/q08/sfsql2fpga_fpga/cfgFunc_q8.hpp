...
void get_cfg_dat_JOIN_INNER_TD_9757_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 3; // l_orderkey#77
...
void get_cfg_dat_JOIN_INNER_TD_9757_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    // input table b
    signed char id_b[] = {1,4,3,2,0,-1,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(120 + 8 * c + 7, 120 + 8 * c) = id_b[c];
    }
    // filter tbl_b config
...
void get_cfg_dat_JOIN_INNER_TD_863_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 2; // l_orderkey#77
    shuffle2_cfg(15, 8) = 1; // l_extendedprice#82
    shuffle2_cfg(23, 16) = 0; // l_discount#83
    shuffle2_cfg(31, 24) = 6; // s_nationkey#345
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    shuffle3_cfg(31, 24) = 3; // s_nationkey#345
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    shuffle4_cfg(31, 24) = 3; // s_nationkey#345
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_863_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_INNER_TD_7371_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 7; // l_extendedprice#82
    shuffle2_cfg(15, 8) = 6; // l_discount#83
    shuffle2_cfg(23, 16) = 8; // s_nationkey#345
    shuffle2_cfg(31, 24) = 0; // o_custkey#208
    shuffle2_cfg(39, 32) = 1; // o_orderdate#211
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    shuffle3_cfg(31, 24) = 3; // o_custkey#208
    ...
    shuffle4_cfg(31, 24) = 3; // o_custkey#208
...
void get_cfg_dat_JOIN_INNER_TD_7371_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;

    // input table a
    signed char id_a[] = {0,2,1,3,-1,-1,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(56 + 8 * c + 7, 56 + 8 * c) = id_a[c];
    }
    // filter tbl_a config
...
void get_cfg_dat_JOIN_INNER_TD_6380_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 8; // l_extendedprice#82
    shuffle2_cfg(15, 8) = 7; // l_discount#83
    shuffle2_cfg(23, 16) = 9; // s_nationkey#345
    shuffle2_cfg(31, 24) = 6; // o_orderdate#211
    shuffle2_cfg(39, 32) = 0; // c_nationkey#25
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    shuffle3_cfg(39, 32) = 4; // c_nationkey#25
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    shuffle4_cfg(39, 32) = 4; // c_nationkey#25
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_6380_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;

    // input table a
    signed char id_a[] = {3,4,1,0,2,-1,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(56 + 8 * c + 7, 56 + 8 * c) = id_a[c];
    }
    // filter tbl_a config
...
void get_cfg_dat_JOIN_INNER_TD_5622_gqe_join(ap_uint<512>* hbuf) {
    ...
    // Right Table: ListBuffer(l_extendedprice#82, l_discount#83, s_nationkey#345, o_orderdate#211, c_nationkey#25)
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 2; // l_extendedprice#82
    shuffle2_cfg(15, 8) = 1; // l_discount#83
    shuffle2_cfg(23, 16) = 3; // s_nationkey#345
    shuffle2_cfg(31, 24) = 0; // o_orderdate#211
    shuffle2_cfg(39, 32) = 6; // n_regionkey#146
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    shuffle3_cfg(23, 16) = 2; // s_nationkey#345
    shuffle3_cfg(31, 24) = 3; // o_orderdate#211
    shuffle3_cfg(39, 32) = 4; // n_regionkey#146
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    shuffle4_cfg(23, 16) = 2; // s_nationkey#345
    shuffle4_cfg(31, 24) = 3; // o_orderdate#211
    shuffle4_cfg(39, 32) = 4; // n_regionkey#146
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_5622_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    // input table b
    signed char id_b[] = {4,3,1,0,2,-1,-1,-1};
    for (int c = 0; c < 8; ++c) {
        t.range(120 + 8 * c + 7, 120 + 8 * c) = id_b[c];
    }
    // filter tbl_b config
...
void get_cfg_dat_JOIN_INNER_TD_4178_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((n_regionkey#146 = r_regionkey#174))
    // Left Table: ListBuffer(r_regionkey#174)
    // Right Table: ListBuffer(l_extendedprice#82, l_discount#83, s_nationkey#345, o_orderdate#211, n_regionkey#146)
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 0; // o_orderdate#211
    shuffle2_cfg(15, 8) = 2; // l_extendedprice#82
    shuffle2_cfg(23, 16) = 1; // l_discount#83
    shuffle2_cfg(31, 24) = 3; // s_nationkey#345
    shuffle2_cfg(39, 32) = 12; // n_regionkey#146
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_4178_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
