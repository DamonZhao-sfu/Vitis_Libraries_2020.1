...
void get_cfg_dat_JOIN_INNER_TD_9824_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((p_partkey#284 = l_partkey#51))
    // Left Table: ListBuffer(p_partkey#284)
    // Right Table: ListBuffer(l_orderkey#50, l_partkey#51, l_suppkey#52, l_extendedprice#55, l_discount#56)
    // Output Table: ListBuffer(l_orderkey#50, l_suppkey#52, l_extendedprice#55, l_discount#56)
    // Node Depth: 9
    ap_uint<512>* b = hbuf;
...
void get_cfg_dat_JOIN_INNER_TD_8790_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    // Output Table: ListBuffer(l_orderkey#50, l_extendedprice#55, l_discount#56, s_nationkey#371)
    // Node Depth: 8
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    shuffle2_cfg(31, 24) = 6; // s_nationkey
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_7830_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((l_orderkey#50 = o_orderkey#227))
    // Left Table: ListBuffer(l_orderkey#50, l_extendedprice#55, l_discount#56, s_nationkey#371)
    // Right Table: ListBuffer(o_orderkey#227, o_custkey#228, o_orderdate#231)
    // Output Table: ListBuffer(l_extendedprice#55, l_discount#56, s_nationkey#371, o_custkey#228, o_orderdate#231)
    // Node Depth: 7
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 6; // l_extendedprice
    shuffle2_cfg(15, 8) = 8; // l_discount
    shuffle2_cfg(23, 16) = 7; // s_nationkey
    shuffle2_cfg(31, 24) = 1; // o_custkey
    shuffle2_cfg(39, 32) = 0; // o_orderdate
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    shuffle3_cfg(31, 24) = 3; // o_custkey
    ...
    shuffle4_cfg(31, 24) = 3; // o_custkey
...
void get_cfg_dat_JOIN_INNER_TD_6198_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((o_custkey#228 = c_custkey#125))
    // Left Table: ListBuffer(l_extendedprice#55, l_discount#56, s_nationkey#371, o_custkey#228, o_orderdate#231)
    // Right Table: ListBuffer(c_custkey#125, c_nationkey#128)
    // Output Table: ListBuffer(l_extendedprice#55, l_discount#56, s_nationkey#371, o_orderdate#231, c_nationkey#128)
    // Node Depth: 6
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 7; // l_extendedprice
    shuffle2_cfg(15, 8) = 9; // l_discount
    shuffle2_cfg(23, 16) = 8; // s_nationkey
    shuffle2_cfg(31, 24) = 6; // o_orderdate
    ...
    shuffle3_cfg(15, 8) = 1; // l_discount
    shuffle3_cfg(23, 16) = 2; // s_nationkey
    shuffle3_cfg(31, 24) = 3; // o_orderdate
    ...
    shuffle4_cfg(15, 8) = 1; // l_discount
    shuffle4_cfg(23, 16) = 2; // s_nationkey
    shuffle4_cfg(31, 24) = 3; // o_orderdate
...
void get_cfg_dat_JOIN_INNER_TD_5622_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((c_nationkey#128 = n_nationkey#164))
    // Left Table: ListBuffer(n_nationkey#164, n_regionkey#166)
    // Right Table: ListBuffer(l_extendedprice#55, l_discount#56, s_nationkey#371, o_orderdate#231, c_nationkey#128)
    // Output Table: ListBuffer(l_extendedprice#55, l_discount#56, s_nationkey#371, o_orderdate#231, n_regionkey#166)
    // Node Depth: 5
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    shuffle2_cfg(31, 24) = 0; // o_orderdate
    shuffle2_cfg(39, 32) = 6; // n_regionkey
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    shuffle3_cfg(23, 16) = 2; // s_nationkey
    shuffle3_cfg(31, 24) = 3; // o_orderdate
    shuffle3_cfg(39, 32) = 4; // n_regionkey
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    shuffle4_cfg(23, 16) = 2; // s_nationkey
    shuffle4_cfg(31, 24) = 3; // o_orderdate
    shuffle4_cfg(39, 32) = 4; // n_regionkey
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_4702_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((n_regionkey#166 = r_regionkey#188))
    // Left Table: ListBuffer(r_regionkey#188)
    // Right Table: ListBuffer(l_extendedprice#55, l_discount#56, s_nationkey#371, o_orderdate#231, n_regionkey#166)
    // Output Table: ListBuffer(o_orderdate#231, l_extendedprice#55, l_discount#56, s_nationkey#371, n_regionkey#166)
    // Node Depth: 4
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 0; // o_orderdate
    shuffle2_cfg(15, 8) = 1; // l_extendedprice
    shuffle2_cfg(23, 16) = 3; // l_discount
    shuffle2_cfg(31, 24) = 2; // s_nationkey
    shuffle2_cfg(39, 32) = 12; // n_regionkey
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // o_orderdate
    shuffle3_cfg(15, 8) = 1; // l_extendedprice
    shuffle3_cfg(23, 16) = 2; // l_discount
    shuffle3_cfg(31, 24) = 3; // s_nationkey
    shuffle3_cfg(39, 32) = 4; // n_regionkey
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // o_orderdate
    shuffle4_cfg(15, 8) = 1; // l_extendedprice
    shuffle4_cfg(23, 16) = 2; // l_discount
    shuffle4_cfg(31, 24) = 3; // s_nationkey
    shuffle4_cfg(39, 32) = 4; // n_regionkey
