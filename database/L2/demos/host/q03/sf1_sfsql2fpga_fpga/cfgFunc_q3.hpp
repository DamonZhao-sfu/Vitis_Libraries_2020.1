...
void get_cfg_dat_JOIN_INNER_TD_3968_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((c_custkey#125 = o_custkey#228))
    // Left Table: ListBuffer(c_custkey#125)
    // Right Table: ListBuffer(o_orderkey#227, o_custkey#228, o_orderdate#231, o_shippriority#234)
    // Output Table: ListBuffer(o_orderkey#227, o_orderdate#231, o_shippriority#234)
    // Node Depth: 3
    ap_uint<512>* b = hbuf;
    ...
    shuffle2_cfg(7, 0) = 2; // o_orderkey
    shuffle2_cfg(15, 8) = 0; // o_orderdate
    shuffle2_cfg(23, 16) = 1; // o_shippriority
    ...
    shuffle3_cfg(15, 8) = 1; // o_orderdate
    shuffle3_cfg(23, 16) = 2; // o_shippriority
    ...
    shuffle4_cfg(15, 8) = 1; // o_orderdate
    shuffle4_cfg(23, 16) = 2; // o_shippriority
...
void get_cfg_dat_JOIN_INNER_TD_2152_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((l_orderkey#50 = o_orderkey#227))
    // Left Table: ListBuffer(l_orderkey#50, l_extendedprice#55, l_discount#56)
    // Right Table: ListBuffer(o_orderkey#227, o_orderdate#231, o_shippriority#234)
    // Output Table: ListBuffer(o_orderdate#231, o_shippriority#234, l_orderkey#50, l_extendedprice#55, l_discount#56)
    // Node Depth: 2
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
    ...
    shuffle2_cfg(15, 8) = 1; // o_shippriority
    shuffle2_cfg(23, 16) = 12; // l_orderkey
    shuffle2_cfg(31, 24) = 6; // l_extendedprice
    shuffle2_cfg(39, 32) = 7; // l_discount
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    shuffle3_cfg(15, 8) = 1; // o_shippriority
    shuffle3_cfg(23, 16) = 2; // l_orderkey
    shuffle3_cfg(31, 24) = 3; // l_extendedprice
    shuffle3_cfg(39, 32) = 4; // l_discount
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    shuffle4_cfg(15, 8) = 1; // o_shippriority
    shuffle4_cfg(23, 16) = 2; // l_orderkey
    shuffle4_cfg(31, 24) = 3; // l_extendedprice
    shuffle4_cfg(39, 32) = 4; // l_discount
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_Aggregate_TD_1746_gqe_aggr(ap_uint<32>* buf) {
    ...
    // Operation: ListBuffer(l_orderkey#50, o_orderdate#231, o_shippriority#234, sum((l_extendedprice#55 * (100 - l_discount#56))) AS revenue#1053L)
    // Input Table: ListBuffer(o_orderdate#231, o_shippriority#234, l_orderkey#50, l_extendedprice#55, l_discount#56)
    // Output Table: ListBuffer(l_orderkey#50, revenue#1053L, o_orderdate#231, o_shippriority#234)
    // Node Depth: 1
    ...
    shuffle1_cfg(23, 16) = 2; // l_orderkey#50
    shuffle1_cfg(31, 24) = 3; // o_orderdate
    shuffle1_cfg(39, 32) = 4; // o_shippriority
    shuffle1_cfg(47, 40) = 8; // revenue
    ...
    shuffle2_cfg(23, 16) = 2; // l_orderkey
    shuffle2_cfg(31, 24) = 3; // o_orderdate
    shuffle2_cfg(39, 32) = 4; // o_shippriority
    shuffle2_cfg(47, 40) = 5; // revenue
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    // filter -> groupBy
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 2; // l_orderkey#50
    shuffle3_cfg(15, 8) = 3; // o_orderdate#231
    shuffle3_cfg(23, 16) = 4; // o_shippriority#234
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 5; // revenue#1053L
    shuffle4_cfg(15, 8) = -1;
