...
void get_cfg_dat_JOIN_INNER_TD_399_gqe_join(ap_uint<512>* hbuf) {
...
void get_cfg_dat_JOIN_INNER_TD_399_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_INNER_TD_2844_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_JOIN_INNER_TD_2844_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_Aggregate_TD_148_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(l_orderkey#77, o_orderdate#211, o_shippriority#214, sum((l_extendedprice#82 * (100 - l_discount#83))) AS revenue#704L)
    // Input Table: ListBuffer(o_orderdate#211, o_shippriority#214, l_orderkey#77, l_extendedprice#82, l_discount#83)
    // Output Table: ListBuffer(l_orderkey#77, revenue#704L, o_orderdate#211, o_shippriority#214)
    // Node Depth: 1
    ...
    shuffle1_cfg(47, 40) = 8; // revenue#704L
    ...
    shuffle2_cfg(47, 40) = 5; // revenue#704L
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 5; // revenue#704L
    shuffle4_cfg(15, 8) = -1;
...
void get_cfg_dat_Aggregate_TD_148_gqe_aggr_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
