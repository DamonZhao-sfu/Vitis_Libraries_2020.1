...
void get_cfg_dat_JOIN_INNER_TD_9898996_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 6; // ss_customer_sk
    shuffle2_cfg(15, 8) = 12; // ss_hdemo_sk
    shuffle2_cfg(23, 16) = 8; // ss_addr_sk
    shuffle2_cfg(31, 24) = 11; // ss_store_sk
    shuffle2_cfg(39, 32) = 9; // ss_ticket_number
    shuffle2_cfg(47, 40) = 10; // ss_coupon_amt
    shuffle2_cfg(55, 48) = 7; // ss_net_profit
    ...
    shuffle3_cfg(7, 0) = 0; // ss_customer_sk
    shuffle3_cfg(15, 8) = 1; // ss_hdemo_sk
    shuffle3_cfg(23, 16) = 2; // ss_addr_sk
    shuffle3_cfg(31, 24) = 3; // ss_store_sk
    shuffle3_cfg(39, 32) = 4; // ss_ticket_number
    shuffle3_cfg(47, 40) = 5; // ss_coupon_amt
    shuffle3_cfg(55, 48) = 6; // ss_net_profit
    ...
    shuffle4_cfg(7, 0) = 0; // ss_customer_sk
    shuffle4_cfg(15, 8) = 1; // ss_hdemo_sk
    shuffle4_cfg(23, 16) = 2; // ss_addr_sk
    shuffle4_cfg(31, 24) = 3; // ss_store_sk
    shuffle4_cfg(39, 32) = 4; // ss_ticket_number
    shuffle4_cfg(47, 40) = 5; // ss_coupon_amt
    shuffle4_cfg(55, 48) = 6; // ss_net_profit
...
void get_cfg_dat_JOIN_INNER_TD_8473776_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 6; // ss_customer_sk
    shuffle2_cfg(15, 8) = 11; // ss_hdemo_sk
    shuffle2_cfg(23, 16) = 8; // ss_addr_sk
    shuffle2_cfg(31, 24) = 9; // ss_ticket_number
    shuffle2_cfg(39, 32) = 10; // ss_coupon_amt
    shuffle2_cfg(47, 40) = 7; // ss_net_profit
    ...
    shuffle3_cfg(15, 8) = 1; // ss_hdemo_sk
    shuffle3_cfg(23, 16) = 2; // ss_addr_sk
    shuffle3_cfg(31, 24) = 3; // ss_ticket_number
    shuffle3_cfg(39, 32) = 4; // ss_coupon_amt
    ...
    shuffle4_cfg(15, 8) = 1; // ss_hdemo_sk
    shuffle4_cfg(23, 16) = 2; // ss_addr_sk
    shuffle4_cfg(31, 24) = 3; // ss_ticket_number
    shuffle4_cfg(39, 32) = 4; // ss_coupon_amt
...
void get_cfg_dat_JOIN_INNER_TD_7582378_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 6; // ss_customer_sk
    shuffle2_cfg(15, 8) = 8; // ss_addr_sk
    shuffle2_cfg(23, 16) = 9; // ss_ticket_number
    shuffle2_cfg(31, 24) = 10; // ss_coupon_amt
    shuffle2_cfg(39, 32) = 7; // ss_net_profit
    ...
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // ss_customer_sk
    shuffle3_cfg(15, 8) = 1; // ss_addr_sk
    shuffle3_cfg(23, 16) = 2; // ss_ticket_number
    shuffle3_cfg(31, 24) = 3; // ss_coupon_amt
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // ss_customer_sk
    shuffle4_cfg(15, 8) = 1; // ss_addr_sk
    shuffle4_cfg(23, 16) = 2; // ss_ticket_number
    shuffle4_cfg(31, 24) = 3; // ss_coupon_amt
