...
void get_cfg_dat_JOIN_INNER_TD_6124675_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(31, 24) = 0; // sr_reason_sk
    shuffle2_cfg(39, 32) = 1; // sr_return_quantity
    ...
    shuffle3_cfg(31, 24) = 3; // sr_reason_sk
    ...
    shuffle4_cfg(31, 24) = 3; // sr_reason_sk
...
void get_cfg_dat_JOIN_INNER_TD_5234396_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 6; // ss_customer_sk
    shuffle2_cfg(15, 8) = 7; // sr_return_quantity
    shuffle2_cfg(23, 16) = 8; // ss_quantity
    shuffle2_cfg(31, 24) = 9; // ss_sales_price
    ...
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // ss_customer_sk
    shuffle3_cfg(15, 8) = 1; // sr_return_quantity
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // ss_customer_sk
    shuffle4_cfg(15, 8) = 1; // sr_return_quantity
...
void get_cfg_dat_Aggregate_TD_3854213_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(ss_customer_sk#1209, sum(act_sales#3544) AS sumsales#3545)
    // Input Table: ListBuffer(ss_customer_sk#1209, act_sales#3544)
    // Output Table: ListBuffer(ss_customer_sk#1209, sumsales#3545)
    // Node Depth: 3
    ...
    shuffle1_cfg(15, 8) = 1; // act_sales#3544
    ...
    // filter -> groupBy
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // ss_customer_sk#1209
    shuffle3_cfg(15, 8) = -1;
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 1; // sumsales#3545
    shuffle4_cfg(15, 8) = -1;
