...
void get_cfg_dat_JOIN_INNER_TD_7959031_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(15, 8) = 7; // ws_net_paid
    ...
    shuffle3_cfg(15, 8) = 1; // ws_net_paid
    ...
    shuffle4_cfg(15, 8) = 1; // ws_net_paid
