...
void get_cfg_dat_JOIN_INNER_TD_5277628_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((d_date_sk#3582 = ws_sold_date_sk#3548))
    // Left Table: ListBuffer(ws_sold_date_sk#3548, ws_item_sk#3551, ws_ext_discount_amt#3570)
    // Right Table: ListBuffer(d_date_sk#3582)
    // Output Table: ListBuffer(ws_item_sk#3551, ws_ext_discount_amt#3570)
    // Node Depth: 5
    ap_uint<512>* b = hbuf;
    ...
    shuffle2_cfg(7, 0) = 6; // ws_item_sk
    shuffle2_cfg(15, 8) = 7; // ws_ext_discount_amt
    ...
    shuffle3_cfg(15, 8) = 1; // ws_ext_discount_amt
    ...
    shuffle4_cfg(15, 8) = 1; // ws_ext_discount_amt
...
void get_cfg_dat_Aggregate_TD_4463533_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(ws_item_sk#3551, CheckOverflow((1.300000 * promote_precision(cast((avg(UnscaledValue(ws_ext_discount_amt#3570)) / 100.0) as decimal(11,6)))), DecimalType(14,7), true) AS (1.3 * avg(ws_ext_discount_amt))#3547)
    // Input Table: ListBuffer(ws_item_sk#3551, ws_ext_discount_amt#3570)
    // Output Table: ListBuffer((1.3 * avg(ws_ext_discount_amt))#3547, ws_item_sk#3551)
    // Node Depth: 4
    ...
    ap_uint<289> op_eval_0 = 0; // (1.300000 * (ws_ext_discount_amt#3570 / 100.0))
    ...
    shuffle1_cfg(7, 0) = 0; // ws_ext_discount_amt
    shuffle1_cfg(15, 8) = 1; // ws_item_sk
    shuffle1_cfg(23, 16) = 8; // (1.3 * avg(ws_ext_discount_amt))
    ...
    // eval1 -> filter
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 0; // ws_ext_discount_amt
    shuffle2_cfg(15, 8) = 1; // ws_item_sk
    shuffle2_cfg(23, 16) = 2; // (1.3 * avg(ws_ext_discount_amt))
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    ...
    // filter -> groupBy
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 1; // ws_item_sk#3551
    shuffle3_cfg(15, 8) = -1;
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 2; // (1.3 * avg(ws_ext_discount_amt))#3547
    shuffle4_cfg(15, 8) = -1;
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_342355_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_JOIN_INNER_TD_2176142_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer(((cast(ws_ext_discount_amt#751 as decimal(14,7)) > (1.3 * avg(ws_ext_discount_amt))#3547) AND (ws_item_sk#3551 = i_item_sk#228)))
    // Left Table: ListBuffer(ws_sold_date_sk#729, ws_ext_discount_amt#751, i_item_sk#228)
    // Right Table: ListBuffer((1.3 * avg(ws_ext_discount_amt))#3547, ws_item_sk#3551)
...
void get_cfg_dat_JOIN_INNER_TD_1785021_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 6; // ws_ext_discount_amt
    shuffle2_cfg(15, 8) = -1;
    shuffle2_cfg(23, 16) = -1;
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // ws_ext_discount_amt
    shuffle3_cfg(15, 8) = -1;
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // ws_ext_discount_amt
    shuffle4_cfg(15, 8) = -1;
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
