...
void get_cfg_dat_JOIN_INNER_TD_445_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((ps_suppkey#330 = s_suppkey#368))
    // Left Table: ListBuffer(s_suppkey#368, s_nationkey#371)
    // Right Table: ListBuffer(ps_partkey#329, ps_suppkey#330, ps_availqty#331, ps_supplycost#332)
    // Output Table: ListBuffer(ps_partkey#329, ps_availqty#331, ps_supplycost#332, s_nationkey#371)
    // Node Depth: 4
    ap_uint<512>* b = hbuf;
    ...
    shuffle2_cfg(7, 0) = 1; // ps_partkey
    shuffle2_cfg(15, 8) = 0; // ps_availqty
    shuffle2_cfg(23, 16) = 2; // ps_supplycost
    ...
    shuffle3_cfg(15, 8) = 1; // ps_availqty
    shuffle3_cfg(23, 16) = 2; // ps_supplycost
    ...
    shuffle4_cfg(15, 8) = 1; // ps_availqty
    shuffle4_cfg(23, 16) = 2; // ps_supplycost
...
void get_cfg_dat_JOIN_INNER_TD_3355_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((s_nationkey#371 = n_nationkey#164))
    // Left Table: ListBuffer(n_nationkey#164)
    // Right Table: ListBuffer(ps_partkey#329, ps_availqty#331, ps_supplycost#332, s_nationkey#371)
    // Output Table: ListBuffer(ps_partkey#329, ps_availqty#331, ps_supplycost#332)
    // Node Depth: 3
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_Aggregate_TD_2588_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(ps_partkey#329, sum((ps_supplycost#332 * ps_availqty#331)) AS value#1475L)
        // Binded Operation: JOIN_INNER -> operations: ListBuffer((s_nationkey#371 = n_nationkey#164))
    // Input Table: ListBuffer(ps_partkey#329, ps_availqty#331, ps_supplycost#332, s_nationkey#371)
    // Output Table: ListBuffer(ps_partkey#329, value#1475L)
    // Node Depth: 2
    ...
    // eval0
    ap_uint<32> t;
    signed char id[] = {2,1,0,3,-1,-1,-1,-1};
    for (int c = 0; c < 4; ++c) {
    ...
    ap_uint<289> op_eval_0 = 0; // (ps_supplycost#332 * ps_availqty#331)
    ...
    shuffle1_cfg(7, 0) = 0; // ps_supplycost
    shuffle1_cfg(15, 8) = 1; // ps_availqty
    shuffle1_cfg(23, 16) = 2; // ps_partkey
    shuffle1_cfg(31, 24) = 3; // s_nationkey#371
    shuffle1_cfg(39, 32) = 8; // value
    ...
    // eval1 -> filter
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 0; // ps_supplycost
    shuffle2_cfg(15, 8) = 1; // ps_availqty
    shuffle2_cfg(23, 16) = 2; // ps_partkey
    shuffle2_cfg(31, 24) = 3; // s_nationkey
    shuffle2_cfg(39, 32) = 4; // value
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    // filter -> groupBy
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 2; // ps_partkey#329
    shuffle3_cfg(15, 8) = -1;
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 4; // value#1475L
    shuffle4_cfg(15, 8) = -1;
