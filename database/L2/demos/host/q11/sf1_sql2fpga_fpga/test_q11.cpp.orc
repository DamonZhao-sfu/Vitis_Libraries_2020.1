...
int main(int argc, const char* argv[]) { 
    ...
    tbl_SerializeFromObject_TD_5938_input = Table("partsupp", partsupp_n, 4, in_dir,"orc");
    ...
    tbl_SerializeFromObject_TD_5455_input = Table("supplier", supplier_n, 2, in_dir,"orc");
    ...
    tbl_SerializeFromObject_TD_5281_input = Table("nation", nation_n, 2, in_dir,"orc");
