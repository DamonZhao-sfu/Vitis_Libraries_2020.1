...
void get_cfg_dat_JOIN_LEFTOUTER_TD_7493053_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(15, 8) = 1; // cs_warehouse_sk
    shuffle2_cfg(23, 16) = 2; // cs_item_sk
    shuffle2_cfg(31, 24) = 3; // cs_sales_price
    shuffle2_cfg(39, 32) = 4; // cr_refunded_cash
    ...
    shuffle3_cfg(15, 8) = 1; // cs_warehouse_sk
    shuffle3_cfg(23, 16) = 2; // cs_item_sk
    shuffle3_cfg(31, 24) = 3; // cs_sales_price
    shuffle3_cfg(39, 32) = 4; // cr_refunded_cash
    ...
    shuffle4_cfg(15, 8) = 1; // cs_warehouse_sk
    shuffle4_cfg(23, 16) = 2; // cs_item_sk
    shuffle4_cfg(31, 24) = 3; // cs_sales_price
    shuffle4_cfg(39, 32) = 4; // cr_refunded_cash
