...
void get_cfg_dat_JOIN_LEFTSEMI_TD_7172_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer(((l_orderkey#77#656 = l_orderkey#77) AND NOT (l_suppkey#79#658 = l_suppkey#79)))
    // Left Table: ListBuffer(l_orderkey#77#656, l_suppkey#79#658)
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_7172_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_6859_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer(((l_orderkey#77#672 = l_orderkey#77) AND NOT (l_suppkey#79#674 = l_suppkey#79)))
    // Left Table: ListBuffer(l_orderkey#77#672, l_suppkey#79#674)
    // Right Table: ListBuffer(l_orderkey#77, l_suppkey#79)
    // Output Table: ListBuffer(l_orderkey#77, l_suppkey#79)
    // Node Depth: 6
    ap_uint<512>* b = hbuf;
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_6859_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_LEFTANTI_TD_5594_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTANTI
    // Operation: ListBuffer(((l_orderkey#77#672 = l_orderkey#77) AND NOT (l_suppkey#79#674 = l_suppkey#79)))
    // Left Table: ListBuffer(l_orderkey#77, l_suppkey#79)
    // Right Table: ListBuffer(l_orderkey#77#672, l_suppkey#79#674)
    // Output Table: ListBuffer(l_orderkey#77, l_suppkey#79)
    // Node Depth: 5
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
...
void get_cfg_dat_JOIN_LEFTANTI_TD_5594_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_INNER_TD_3576_gqe_join(ap_uint<512>* hbuf) {
...
void get_cfg_dat_JOIN_INNER_TD_3576_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_INNER_TD_4630_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: true StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_JOIN_INNER_TD_4630_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_INNER_TD_2550_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: true StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
...
void get_cfg_dat_JOIN_INNER_TD_2550_gqe_join_part(ap_uint<512>* hbuf) {
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
