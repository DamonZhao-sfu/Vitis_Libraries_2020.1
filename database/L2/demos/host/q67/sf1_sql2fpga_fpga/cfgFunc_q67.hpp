...
void get_cfg_dat_JOIN_INNER_TD_9293512_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(39, 32) = 2; // d_year
    shuffle2_cfg(47, 40) = 0; // d_moy
    shuffle2_cfg(55, 48) = 1; // d_qoy
    ...
    shuffle3_cfg(39, 32) = 4; // d_year
    shuffle3_cfg(47, 40) = 5; // d_moy
    shuffle3_cfg(55, 48) = 6; // d_qoy
    ...
    shuffle4_cfg(39, 32) = 4; // d_year
    shuffle4_cfg(47, 40) = 5; // d_moy
    shuffle4_cfg(55, 48) = 6; // d_qoy
