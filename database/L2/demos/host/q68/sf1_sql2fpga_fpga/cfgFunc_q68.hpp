...
void get_cfg_dat_JOIN_INNER_TD_8855685_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 7; // ss_customer_sk
    ...
    shuffle2_cfg(47, 40) = 11; // ss_ext_list_price
    shuffle2_cfg(55, 48) = 10; // ss_ext_tax
    ...
    shuffle3_cfg(47, 40) = 5; // ss_ext_list_price
    shuffle3_cfg(55, 48) = 6; // ss_ext_tax
    ...
    shuffle4_cfg(47, 40) = 5; // ss_ext_list_price
    shuffle4_cfg(55, 48) = 6; // ss_ext_tax
...
void get_cfg_dat_JOIN_INNER_TD_7768905_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    shuffle2_cfg(39, 32) = 11; // ss_ext_list_price
    shuffle2_cfg(47, 40) = 10; // ss_ext_tax
    ...
    shuffle3_cfg(39, 32) = 4; // ss_ext_list_price
    shuffle3_cfg(47, 40) = 5; // ss_ext_tax
    ...
    shuffle4_cfg(39, 32) = 4; // ss_ext_list_price
    shuffle4_cfg(47, 40) = 5; // ss_ext_tax
