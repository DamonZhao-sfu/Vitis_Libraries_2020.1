...
void get_cfg_dat_JOIN_INNER_TD_10280374_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 6; // wr_returning_customer_sk
    shuffle2_cfg(15, 8) = 7; // wr_returning_addr_sk
    shuffle2_cfg(23, 16) = 8; // wr_return_amt
    ...
    shuffle3_cfg(7, 0) = 0; // wr_returning_customer_sk
    shuffle3_cfg(15, 8) = 1; // wr_returning_addr_sk
    ...
    shuffle4_cfg(7, 0) = 0; // wr_returning_customer_sk
    shuffle4_cfg(15, 8) = 1; // wr_returning_addr_sk
...
void get_cfg_dat_JOIN_INNER_TD_9405197_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((wr_returned_date_sk#831 = d_date_sk#120))
    // Left Table: ListBuffer(wr_returned_date_sk#831, wr_returning_customer_sk#838, wr_returning_addr_sk#841, wr_return_amt#846)
