...
void get_cfg_dat_Aggregate_TD_10584880_gqe_aggr(ap_uint<32>* buf) {
    ...
    // Input Table: ListBuffer(ss_store_sk#3641, ss_net_profit#3656)
    // Output Table: ListBuffer(rank_col#3551)
    // Node Depth: 10
    ...
    ap_uint<289> op_eval_0 = 0; // (ss_net_profit#3656 / 100.0)
    ...
    shuffle1_cfg(7, 0) = 0; // ss_net_profit
    shuffle1_cfg(15, 8) = 1; // ss_store_sk
    shuffle1_cfg(23, 16) = 8; // rank_col
    ...
    shuffle2_cfg(7, 0) = 0; // ss_net_profit
    shuffle2_cfg(15, 8) = 1; // ss_store_sk
    shuffle2_cfg(23, 16) = 2; // rank_col
    ...
    shuffle3_cfg(7, 0) = 1; // ss_store_sk#3641
    shuffle3_cfg(15, 8) = -1;
    ...
    shuffle4_cfg(7, 0) = 2; // rank_col#3551
    shuffle4_cfg(15, 8) = -1;
...
void get_cfg_dat_Aggregate_TD_10335950_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(ss_store_sk#3618, cast((avg(UnscaledValue(ss_net_profit#3633)) / 100.0) as decimal(11,6)) AS rank_col#3546)
    // Input Table: ListBuffer(ss_store_sk#3618, ss_net_profit#3633)
    // Output Table: ListBuffer(rank_col#3546)
    // Node Depth: 10
    ap_uint<32>* config = buf;
    memset(config, 0, sizeof(ap_uint<32>) * 83);
    ...
    ap_uint<289> op_eval_0 = 0; // (ss_net_profit#3633 / 100.0)
    xf::database::dynamicALUOPCompiler<uint32_t, uint32_t, uint32_t, uint32_t>("strm1", 0, 0, 0, 0, op_eval_0);
    for (int i = 0; i < 9; i++) {
        config[i + 2] = op_eval_0(32 * (i + 1) - 1, 32 * i);
    }
    ...
    // filter -> groupBy
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 1; // ss_store_sk#3618
    shuffle3_cfg(15, 8) = -1;
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 2; // rank_col#3546
    shuffle4_cfg(15, 8) = -1;
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_6645449_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 0; // item_sk
    shuffle2_cfg(15, 8) = 12; // rnk
    shuffle2_cfg(23, 16) = 0; // item_sk
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 2; // item_sk
    shuffle3_cfg(15, 8) = 1; // rnk
    shuffle3_cfg(23, 16) = 2; // item_sk
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 2; // item_sk
    shuffle4_cfg(15, 8) = 1; // rnk
    shuffle4_cfg(23, 16) = 2; // item_sk
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
