...
void get_cfg_dat_JOIN_INNER_TD_8575196_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(15, 8) = 7; // ss_item_sk
    shuffle2_cfg(23, 16) = 9; // ss_store_sk
    shuffle2_cfg(31, 24) = 11; // ss_quantity
    shuffle2_cfg(39, 32) = 10; // ss_list_price
    shuffle2_cfg(47, 40) = 12; // ss_sales_price
    shuffle2_cfg(55, 48) = 8; // ss_coupon_amt
    ...
    shuffle3_cfg(39, 32) = 4; // ss_list_price
    shuffle3_cfg(47, 40) = 5; // ss_sales_price
    shuffle3_cfg(55, 48) = 6; // ss_coupon_amt
    ...
    shuffle4_cfg(39, 32) = 4; // ss_list_price
    shuffle4_cfg(47, 40) = 5; // ss_sales_price
    shuffle4_cfg(55, 48) = 6; // ss_coupon_amt
...
void get_cfg_dat_JOIN_INNER_TD_7348578_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    shuffle2_cfg(31, 24) = 9; // ss_list_price
    shuffle2_cfg(39, 32) = 11; // ss_sales_price
    shuffle2_cfg(47, 40) = 7; // ss_coupon_amt
