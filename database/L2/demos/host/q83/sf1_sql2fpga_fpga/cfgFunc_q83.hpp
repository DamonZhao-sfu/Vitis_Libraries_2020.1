...
void get_cfg_dat_JOIN_LEFTSEMI_TD_9296332_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer((d_week_seq#3776 = d_week_seq#3692))
    // Left Table: ListBuffer(d_week_seq#3692)
    // Right Table: ListBuffer(d_date#3774, d_week_seq#3776)
    // Output Table: ListBuffer(d_date#3774)
    // Node Depth: 9
    ap_uint<512>* b = hbuf;
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_934800_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer((d_week_seq#3748 = d_week_seq#3664))
    // Left Table: ListBuffer(d_week_seq#3664)
    // Right Table: ListBuffer(d_date#3746, d_week_seq#3748)
    // Output Table: ListBuffer(d_date#3746)
    // Node Depth: 9
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_8468980_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer((d_week_seq#3804 = d_week_seq#3720))
    // Left Table: ListBuffer(d_week_seq#3720)
    // Right Table: ListBuffer(d_date#3802, d_week_seq#3804)
    // Output Table: ListBuffer(d_date#3802)
    // Node Depth: 8
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_8973839_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer((d_date#3584 = d_date#3774))
    // Left Table: ListBuffer(d_date#3774)
    // Right Table: ListBuffer(d_date_sk#3582, d_date#3584)
    // Output Table: ListBuffer(d_date_sk#3582)
    // Node Depth: 8
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_8288015_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer((d_date#122 = d_date#3746))
    // Left Table: ListBuffer(d_date#3746)
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_7153185_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer((d_date#3634 = d_date#3802))
    // Left Table: ListBuffer(d_date#3802)
    // Right Table: ListBuffer(d_date_sk#3632, d_date#3634)
    // Output Table: ListBuffer(d_date_sk#3632)
    // Node Depth: 7
    ap_uint<512>* b = hbuf;
    memset(b, 0, sizeof(ap_uint<512>) * 9);
    ap_uint<512> t = 0;
