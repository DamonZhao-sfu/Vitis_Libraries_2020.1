...
void get_cfg_dat_JOIN_INNER_TD_9659581_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(15, 8) = 6; // ws_item_sk
    shuffle2_cfg(23, 16) = 8; // ws_sales_price
    shuffle2_cfg(31, 24) = 0; // c_current_addr_sk
    ...
    shuffle3_cfg(23, 16) = 2; // ws_sales_price
    shuffle3_cfg(31, 24) = 3; // c_current_addr_sk
    ...
    shuffle4_cfg(23, 16) = 2; // ws_sales_price
    shuffle4_cfg(31, 24) = 3; // c_current_addr_sk
