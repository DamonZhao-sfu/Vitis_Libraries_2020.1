...
void get_cfg_dat_JOIN_INNER_TD_9944205_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 7; // ss_sold_date_sk
    shuffle2_cfg(15, 8) = 8; // ss_item_sk
    shuffle2_cfg(23, 16) = 9; // ss_store_sk
    shuffle2_cfg(31, 24) = 11; // ss_quantity
    shuffle2_cfg(39, 32) = 6; // sr_returned_date_sk
    shuffle2_cfg(47, 40) = 10; // sr_return_quantity
    shuffle2_cfg(55, 48) = 0; // cs_sold_date_sk
    shuffle2_cfg(63, 56) = 1; // cs_quantity
    ...
    shuffle3_cfg(47, 40) = 5; // sr_return_quantity
    shuffle3_cfg(55, 48) = 6; // cs_sold_date_sk
    shuffle3_cfg(63, 56) = 7; // cs_quantity
    ...
    shuffle4_cfg(47, 40) = 5; // sr_return_quantity
    shuffle4_cfg(55, 48) = 6; // cs_sold_date_sk
    shuffle4_cfg(63, 56) = 7; // cs_quantity
...
void get_cfg_dat_JOIN_INNER_TD_8800395_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    shuffle2_cfg(23, 16) = 12; // ss_quantity
    shuffle2_cfg(31, 24) = 7; // sr_returned_date_sk
    shuffle2_cfg(39, 32) = 11; // sr_return_quantity
    shuffle2_cfg(47, 40) = 6; // cs_sold_date_sk
    shuffle2_cfg(55, 48) = 8; // cs_quantity
    ...
    shuffle3_cfg(39, 32) = 4; // sr_return_quantity
    shuffle3_cfg(47, 40) = 5; // cs_sold_date_sk
    shuffle3_cfg(55, 48) = 6; // cs_quantity
    ...
    shuffle4_cfg(39, 32) = 4; // sr_return_quantity
    shuffle4_cfg(47, 40) = 5; // cs_sold_date_sk
    shuffle4_cfg(55, 48) = 6; // cs_quantity
...
void get_cfg_dat_JOIN_INNER_TD_7191732_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((sr_returned_date_sk#669 = d_date_sk#3550))
    ...
    // Right Table: ListBuffer(d_date_sk#3550)
    ...
    shuffle1a_cfg(7, 0) = 3;
    shuffle1a_cfg(15, 8) = 5;
    shuffle1a_cfg(23, 16) = 6;
    shuffle1a_cfg(31, 24) = 0;
    shuffle1a_cfg(39, 32) = 1;
    shuffle1a_cfg(47, 40) = 4;
    shuffle1a_cfg(55, 48) = 2;
    ...
    shuffle2_cfg(15, 8) = 9; // ss_store_sk
    shuffle2_cfg(23, 16) = 11; // ss_quantity
    shuffle2_cfg(31, 24) = 10; // sr_return_quantity
    shuffle2_cfg(39, 32) = 6; // cs_sold_date_sk
    shuffle2_cfg(47, 40) = 7; // cs_quantity
    ...
    shuffle3_cfg(15, 8) = 1; // ss_store_sk
    shuffle3_cfg(23, 16) = 2; // ss_quantity
    shuffle3_cfg(31, 24) = 3; // sr_return_quantity
    shuffle3_cfg(39, 32) = 4; // cs_sold_date_sk
    shuffle3_cfg(47, 40) = 5; // cs_quantity
    ...
    shuffle4_cfg(15, 8) = 1; // ss_store_sk
    shuffle4_cfg(23, 16) = 2; // ss_quantity
    shuffle4_cfg(31, 24) = 3; // sr_return_quantity
    shuffle4_cfg(39, 32) = 4; // cs_sold_date_sk
    shuffle4_cfg(47, 40) = 5; // cs_quantity
...
void get_cfg_dat_JOIN_INNER_TD_6555791_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((cs_sold_date_sk#1104 = d_date_sk#3578))
    ...
    // Right Table: ListBuffer(d_date_sk#3578)
    ...
    shuffle2_cfg(15, 8) = 8; // ss_store_sk
    shuffle2_cfg(23, 16) = 10; // ss_quantity
    shuffle2_cfg(31, 24) = 9; // sr_return_quantity
    shuffle2_cfg(39, 32) = 6; // cs_quantity
    ...
    shuffle3_cfg(23, 16) = 2; // ss_quantity
    shuffle3_cfg(31, 24) = 3; // sr_return_quantity
    shuffle3_cfg(39, 32) = 4; // cs_quantity
    ...
    shuffle4_cfg(23, 16) = 2; // ss_quantity
    shuffle4_cfg(31, 24) = 3; // sr_return_quantity
    shuffle4_cfg(39, 32) = 4; // cs_quantity
