...
void get_cfg_dat_JOIN_LEFTANTI_TD_3172_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 1; // c_phone
    shuffle2_cfg(15, 8) = 0; // c_acctbal
    ...
    shuffle3_cfg(7, 0) = 0; // c_phone
    shuffle3_cfg(15, 8) = 1; // c_acctbal
    ...
    shuffle4_cfg(7, 0) = 0; // c_phone
    shuffle4_cfg(15, 8) = 1; // c_acctbal
