...
void get_cfg_dat_JOIN_INNER_TD_7800854_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 8; // inv_item_sk
    shuffle2_cfg(15, 8) = 7; // inv_warehouse_sk
    shuffle2_cfg(23, 16) = 6; // inv_quantity_on_hand
    ...
    shuffle3_cfg(7, 0) = 0; // inv_item_sk
    shuffle3_cfg(15, 8) = 1; // inv_warehouse_sk
    shuffle3_cfg(23, 16) = 2; // inv_quantity_on_hand
    ...
    shuffle4_cfg(7, 0) = 0; // inv_item_sk
    shuffle4_cfg(15, 8) = 1; // inv_warehouse_sk
    shuffle4_cfg(23, 16) = 2; // inv_quantity_on_hand
