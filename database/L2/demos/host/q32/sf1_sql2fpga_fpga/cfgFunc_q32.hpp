...
void get_cfg_dat_JOIN_INNER_TD_5608393_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer((d_date_sk#3582 = cs_sold_date_sk#3548))
    // Left Table: ListBuffer(cs_sold_date_sk#3548, cs_item_sk#3563, cs_ext_discount_amt#3570)
    // Right Table: ListBuffer(d_date_sk#3582)
    // Output Table: ListBuffer(cs_item_sk#3563, cs_ext_discount_amt#3570)
    // Node Depth: 5
    ap_uint<512>* b = hbuf;
    ...
    shuffle2_cfg(7, 0) = 6; // cs_item_sk
    shuffle2_cfg(15, 8) = 7; // cs_ext_discount_amt
    ...
    shuffle3_cfg(15, 8) = 1; // cs_ext_discount_amt
    ...
    shuffle4_cfg(15, 8) = 1; // cs_ext_discount_amt
...
void get_cfg_dat_Aggregate_TD_4606231_gqe_aggr(ap_uint<32>* buf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: Aggregate
    // Operation: ListBuffer(cs_item_sk#3563, CheckOverflow((1.300000 * promote_precision(cast((avg(UnscaledValue(cs_ext_discount_amt#3570)) / 100.0) as decimal(11,6)))), DecimalType(14,7), true) AS (1.3 * avg(cs_ext_discount_amt))#3547)
    // Input Table: ListBuffer(cs_item_sk#3563, cs_ext_discount_amt#3570)
    // Output Table: ListBuffer((1.3 * avg(cs_ext_discount_amt))#3547, cs_item_sk#3563)
    // Node Depth: 4
    ...
    ap_uint<289> op_eval_0 = 0; // (1.300000 * (cs_ext_discount_amt#3570 / 100.0))
    xf::database::dynamicALUOPCompiler<uint32_t, uint32_t, uint32_t, uint32_t>("c1*strm2", 1, 0, 0, 0, op_eval_0);
    for (int i = 0; i < 9; i++) {
    ...
    shuffle1_cfg(7, 0) = 0; // cs_ext_discount_amt
    shuffle1_cfg(15, 8) = 1; // cs_item_sk
    shuffle1_cfg(23, 16) = 8; // (1.3 * avg(cs_ext_discount_amt))
    ...
    // eval1 -> filter
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 0; // cs_ext_discount_amt
    shuffle2_cfg(15, 8) = 1; // cs_item_sk
    shuffle2_cfg(23, 16) = 2; // (1.3 * avg(cs_ext_discount_amt))
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    ...
    // filter -> groupBy
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 1; // cs_item_sk#3563
    shuffle3_cfg(15, 8) = -1;
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 2; // (1.3 * avg(cs_ext_discount_amt))#3547
    shuffle4_cfg(15, 8) = -1;
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_3122102_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    shuffle2_cfg(15, 8) = 7; // cs_ext_discount_amt
    shuffle2_cfg(23, 16) = 12; // i_item_sk
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    ...
    shuffle3_cfg(15, 8) = 1; // cs_ext_discount_amt
    shuffle3_cfg(23, 16) = 2; // i_item_sk
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    ...
    shuffle4_cfg(15, 8) = 1; // cs_ext_discount_amt
    shuffle4_cfg(23, 16) = 2; // i_item_sk
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_2562385_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer(((cast(cs_ext_discount_amt#1126 as decimal(14,7)) > (1.3 * avg(cs_ext_discount_amt))#3547) AND (cs_item_sk#3563 = i_item_sk#228)))
    // Left Table: ListBuffer(cs_sold_date_sk#1104, cs_ext_discount_amt#1126, i_item_sk#228)
    // Right Table: ListBuffer((1.3 * avg(cs_ext_discount_amt))#3547, cs_item_sk#3563)
...
void get_cfg_dat_JOIN_INNER_TD_1846235_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 6; // cs_ext_discount_amt
    shuffle2_cfg(15, 8) = -1;
    shuffle2_cfg(23, 16) = -1;
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // cs_ext_discount_amt
    shuffle3_cfg(15, 8) = -1;
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // cs_ext_discount_amt
    shuffle4_cfg(15, 8) = -1;
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
