...
void get_cfg_dat_JOIN_INNER_TD_6127464_gqe_join(ap_uint<512>* hbuf) {
    ...
    shuffle2_cfg(7, 0) = 12; // ws_order_number
    shuffle2_cfg(15, 8) = -1;
    ...
    shuffle3_cfg(7, 0) = 0; // ws_order_number
    shuffle3_cfg(15, 8) = -1;
    ...
    shuffle4_cfg(7, 0) = 0; // ws_order_number
    shuffle4_cfg(15, 8) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_6724276_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    // Operation: ListBuffer(((ws_order_number#746L = ws_order_number#3568L) AND NOT (ws_warehouse_sk#744 = ws_warehouse_sk#3566)))
    // Left Table: ListBuffer(ws_warehouse_sk#744, ws_order_number#746L)
...
void get_cfg_dat_JOIN_INNER_TD_5255352_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 12; // wr_order_number
    shuffle2_cfg(15, 8) = -1;
    shuffle2_cfg(23, 16) = -1;
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // wr_order_number
    shuffle3_cfg(15, 8) = -1;
    shuffle3_cfg(23, 16) = -1;
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // wr_order_number
    shuffle4_cfg(15, 8) = -1;
    shuffle4_cfg(23, 16) = -1;
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_552916_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
    // Operation: ListBuffer((ws_order_number#3602L = ws_order_number#746L))
    // Left Table: ListBuffer(ws_order_number#746L)
    // Right Table: ListBuffer(ws_ship_date_sk#3587, ws_ship_addr_sk#3596, ws_web_site_sk#3598, ws_order_number#3602L, ws_ext_ship_cost#3613, ws_net_profit#3618)
    ...
    shuffle1b_cfg(31, 24) = 5;
    shuffle1b_cfg(39, 32) = 1;
    shuffle1b_cfg(47, 40) = 4;
    shuffle1b_cfg(55, 48) = -1;
    shuffle1b_cfg(63, 56) = -1;
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 0; // ws_ship_date_sk
    shuffle2_cfg(15, 8) = 3; // ws_ship_addr_sk
    shuffle2_cfg(23, 16) = 1; // ws_web_site_sk
    shuffle2_cfg(31, 24) = 12; // ws_order_number
    shuffle2_cfg(39, 32) = 4; // ws_ext_ship_cost
    shuffle2_cfg(47, 40) = 2; // ws_net_profit
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // ws_ship_date_sk
    shuffle3_cfg(15, 8) = 1; // ws_ship_addr_sk
    shuffle3_cfg(23, 16) = 2; // ws_web_site_sk
    shuffle3_cfg(31, 24) = 3; // ws_order_number
    shuffle3_cfg(39, 32) = 4; // ws_ext_ship_cost
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // ws_ship_date_sk
    shuffle4_cfg(15, 8) = 1; // ws_ship_addr_sk
    shuffle4_cfg(23, 16) = 2; // ws_web_site_sk
    shuffle4_cfg(31, 24) = 3; // ws_order_number
    shuffle4_cfg(39, 32) = 4; // ws_ext_ship_cost
...
void get_cfg_dat_JOIN_LEFTSEMI_TD_4697125_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_LEFTSEMI
...
void get_cfg_dat_JOIN_INNER_TD_3440127_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 9; // ws_ship_addr_sk
    shuffle2_cfg(15, 8) = 7; // ws_web_site_sk
    shuffle2_cfg(23, 16) = 6; // ws_order_number
    shuffle2_cfg(31, 24) = 10; // ws_ext_ship_cost
    shuffle2_cfg(39, 32) = 8; // ws_net_profit
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    //stream shuffle 3
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // ws_ship_addr_sk
    shuffle3_cfg(15, 8) = 1; // ws_web_site_sk
    shuffle3_cfg(23, 16) = 2; // ws_order_number
    shuffle3_cfg(31, 24) = 3; // ws_ext_ship_cost
    ...
    //stream shuffle 4
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // ws_ship_addr_sk
    shuffle4_cfg(15, 8) = 1; // ws_web_site_sk
    shuffle4_cfg(23, 16) = 2; // ws_order_number
    shuffle4_cfg(31, 24) = 3; // ws_ext_ship_cost
...
void get_cfg_dat_JOIN_INNER_TD_2754169_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 7; // ws_web_site_sk
    shuffle2_cfg(15, 8) = 6; // ws_order_number
    shuffle2_cfg(23, 16) = 9; // ws_ext_ship_cost
    shuffle2_cfg(31, 24) = 8; // ws_net_profit
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    shuffle2_cfg(63, 56) = -1;
    ...
    shuffle3_cfg(15, 8) = 1; // ws_order_number
    shuffle3_cfg(23, 16) = 2; // ws_ext_ship_cost
    shuffle3_cfg(31, 24) = 3; // ws_net_profit
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    shuffle3_cfg(63, 56) = -1;
    ...
    shuffle4_cfg(15, 8) = 1; // ws_order_number
    shuffle4_cfg(23, 16) = 2; // ws_ext_ship_cost
    shuffle4_cfg(31, 24) = 3; // ws_net_profit
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
    shuffle4_cfg(63, 56) = -1;
...
void get_cfg_dat_JOIN_INNER_TD_1787047_gqe_join(ap_uint<512>* hbuf) {
    // StringRowIDSubstitution: false StringRowIDBackSubstitution: false
    // Supported operation: JOIN_INNER
    ...
    //stream shuffle 2
    ap_int<64> shuffle2_cfg;
    shuffle2_cfg(7, 0) = 6; // ws_order_number
    shuffle2_cfg(15, 8) = 8; // ws_ext_ship_cost
    shuffle2_cfg(23, 16) = 7; // ws_net_profit
    shuffle2_cfg(31, 24) = -1;
    shuffle2_cfg(39, 32) = -1;
    shuffle2_cfg(47, 40) = -1;
    shuffle2_cfg(55, 48) = -1;
    ...
    ap_int<64> shuffle3_cfg;
    shuffle3_cfg(7, 0) = 0; // ws_order_number
    shuffle3_cfg(15, 8) = 1; // ws_ext_ship_cost
    shuffle3_cfg(23, 16) = 2; // ws_net_profit
    shuffle3_cfg(31, 24) = -1;
    shuffle3_cfg(39, 32) = -1;
    shuffle3_cfg(47, 40) = -1;
    shuffle3_cfg(55, 48) = -1;
    ...
    ap_int<64> shuffle4_cfg;
    shuffle4_cfg(7, 0) = 0; // ws_order_number
    shuffle4_cfg(15, 8) = 1; // ws_ext_ship_cost
    shuffle4_cfg(23, 16) = 2; // ws_net_profit
    shuffle4_cfg(31, 24) = -1;
    shuffle4_cfg(39, 32) = -1;
    shuffle4_cfg(47, 40) = -1;
    shuffle4_cfg(55, 48) = -1;
